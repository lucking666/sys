...
# std=0.5
# 加噪声mae——0.2306279679481345,rmse——0.2696597093204824
# XGB加噪声加特征选择算法mae——0.06086448352623618,rmse——0.06480338215385134
# LSSVR加噪声加特征选择算法mae——0.20063858086827102,rmse——0.20168394449888266
# SVM加噪声加特征选择算法mae——0.15247108747709986,rmse——0.1548724717142737
# GPR加噪声加特征选择算法mae——0.6493070140092436,rmse——0.7722354934886814


# 加噪声mae——0.2306279679481345,rmse——0.2696597093204824
# XGB加噪声加特征选择算法mae——0.06086448352623618,rmse——0.06480338215385134
# LR加噪声加特征选择算法mae——0.04299763906379511,rmse——0.04720565039397681
# TLS加噪声加特征选择算法mae——0.05932045921264059,rmse——0.06654367320504746
# PLS加噪声加特征选择算法mae——0.06586125664383263,rmse——0.06974522178952336
# LSSVR加噪声加特征选择算法mae——0.20063858086827102,rmse——0.20168394449888266
# CNN加噪声加特征选择算法mae——0.6273982155898663,rmse——0.6293162264362067
# SVM加噪声加特征选择算法mae——0.15247108747709986,rmse——0.1548724717142737
# GPR加噪声加特征选择算法mae——0.6493070140092436,rmse——0.7722354934886814
