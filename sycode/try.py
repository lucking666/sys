...
for x in range(w):
    ...
    for j in n_list:  # 调整噪声大小
        ...
        times[0] = (times[0] * temp_j)
        times[1] = (times[1] * temp_j)
        times[2] = (times[2] * temp_j)

        print(times)
        print("noise_level:", temp_j)
        ...
        med_tls_rmse.append(np.median(tls_rmse))
        print('tls_rmse',j,np.median(tls_rmse))
        print('ls_rmse', j, np.median(ls_rmse))
