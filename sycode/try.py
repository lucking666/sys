...
def add_em(X, Y,flag,x_test,Y_test,W0, b0,N_train):
    ...
    # plt.show()
    print('hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh',flag)
    print(std_list)
    ...
    for rise in train_array:
        ...
        for p in range(s):  # 分割数据
            ...
            for k in range(m):  # 生成m次噪声
                ...
                W_tls_em, b_tls_em ,std_list_tlsem= add_em(x_train, Y_train_noise, 'tls', x_test, Y_test,W_tls, b_tls,N_train)#x:array,y:array,(-1,1)
                ...
                W_ls_em, b_ls_em ,std_list_lsem= add_em(x_train, Y_train_noise, 'ls', x_test, Y_test,W_ls, b_ls,N_train)
        ...
        std_tlsem.append(std_list_tlsem)
        std_lsem.append(std_list_lsem)
