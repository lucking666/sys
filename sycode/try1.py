...
med_tls_em_rmse=[0.06612994717290893, 0.06617602702651772, 0.0663149696232424, 0.06629701739706254, 0.06632300928714852, 0.06637033581918822, 0.06641462566844651, 0.06646357741500655, 0.06653137935405046, 0.0665688947727903, 0.06669016168584671]
med_tls_rmse=[0.06687183714866657, 0.06740224324127533, 0.06814326087675415, 0.06881902313038854, 0.0703412956247417, 0.07142788094642942, 0.07301847773842868, 0.07465190533748174, 0.07648657263964431, 0.07822702514784093, 0.08042123765780732]
med_ls_em_rmse=[0.06690683824416815, 0.06695813726062452, 0.06696070662528492, 0.06697781339625039, 0.06699235210022383, 0.0669183655320919, 0.06687044931660774, 0.06693399912226891, 0.0669339748167753, 0.06694257803785447, 0.06706154819242968]
data=f"med_tls_em_rmse={med_tls_em_rmse}\nmed_tls_rmse={med_tls_rmse}\nmed_ls_em_rmse={med_ls_em_rmse}"
# np.savetxt("ghdfs.txt",data)#
with open("ghdfs.txt",'w') as file:
    file.write(data)
# data=pd.DataFrame({'med_tls_em_rmse':med_tls_em_rmse})
# data.to_csv("med_tls_em_rmse.csv")
# from linear_regression_std import
# np.savetxt("ghdfs.txt",med_tls_em_rmse,fmt='%f',delimiter=',')#
#
