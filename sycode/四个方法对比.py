...
def add_em(X, Y, flag, x_test, Y_test, W0, b0):
    ...
    while i < 20:  # dis>1e-10
        ...
        X_dataframe[N_train[0]:N_train[1] + N_train[0], 0:6] = X_dataframe[N_train[0]:N_train[1] + N_train[0], 0:6] * \
                                                               lamuda[1]
        X_dataframe[N_train[1] + N_train[0]:N_train[1] + N_train[0] + N_train[2], 0:6] = X_dataframe[
                                                                                         N_train[1] + N_train[0]:
                                                                                         N_train[1] + N_train[0] +
                                                                                         N_train[2], 0:6] * lamuda[2]
...
for x in range(w):
    ...
    print('med_ls_em_rmse:', med_tls_em_rmse)
    print('med_ls_rmse:', med_tls_rmse)
